final class CloudDefaultIsolationFixture {
    var theme: String {
        get {
    ...
    private final class CloudObservation: @unchecked Sendable {
        ...
        init(host: CloudDefaultIsolationFixture, prefix: String) {
            self.host = host
            self.prefix = prefix
...
extension CloudDefaultIsolationFixture: Observation.Observable {
}