final class CloudSyncImmediatelyFixture {
    var theme: String {
        get {
    ...
    internal nonisolated func access<Member>(keyPath: KeyPath<CloudSyncImmediatelyFixture, Member>) {
    ...
    internal nonisolated func withMutation<Member, T>(keyPath: KeyPath<CloudSyncImmediatelyFixture, Member>, _ mutation: () throws -> T) rethrows -> T {
    ...
    private var _syncImmediately = true
    ...
    private var _developmentMode: Bool = false
    ...
    private final class CloudObservation: @unchecked Sendable {
        ...
        private func cloudStoreDidChange(_ notification: Foundation.Notification) {
            ...
            for key in changedKeys {
                switch key {
                    case prefix + "theme": host._$observationRegistrar.withMutation(of: host, keyPath: \.theme) {}
                    default:
                        break
                }
            }
...
extension CloudSyncImmediatelyFixture: Observation.Observable {
}